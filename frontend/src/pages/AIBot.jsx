...
const mockProblems = [
  { id: 1, title: "Strong Tsunami Alert", status: "Pending - Verification by INCOIS team" },
  { id: 2, title: "Storm Surge Flooding in Kochi", status: "In Progress - Local authorities alerted" },
  { id: 3, title: "High Waves Hitting Coast in Vizag", status: "Resolved - Fishermen warned and evacuated" },
  { id: 4, title: "Swell Surge Reported in Mangaluru", status: "Pending - Data validation in progress" },
  { id: 5, title: "Coastal Flooding in Thiruvananthapuram", status: "In Progress - Relief operations ongoing" },
  { id: 6, title: "Dangerous Coastal Currents in Puri", status: "Resolved - Warning issued to fishermen" },
  { id: 7, title: "Abnormal Sea Behaviour in Digha", status: "Pending - Under expert analysis" },
  { id: 8, title: "Coastal Erosion in Goa", status: "In Progress - Geological survey team deployed" },
  { id: 9, title: "Cyclone Updates Trending on Twitter", status: "Monitoring - Social media data being analyzed" },
];
